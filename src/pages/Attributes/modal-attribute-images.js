        ...
        >
            {
                actionsLoading ? 'Loading...' : <>
                    ...
                    <ModalBody>
                        ...
                        {
                            item.forbidden_attributes && item.forbidden_attributes.length > 0 && <span><strong>Forbidden attributes:</strong> {item.forbidden_attributes.map(x => x.value).join(', ')}</span>
                        }<br />
                        {
                            item.forbidden_trait_types && item.forbidden_trait_types.length > 0 && <span><strong>Forbidden trait types:</strong> {item.forbidden_trait_types.map(x => x.name).join(', ')}</span>
                        }<br />
