            ...
            <ModalBody>
              {
                ...
                <div style={{width:'60%'}}>
                 <img id={autogeneratedAvatar.image+'?'+Date.now()} src={autogeneratedAvatar.image ? autogeneratedAvatar.image+'?'+Date.now() : ''} style={{width:'100%', paddingRight:'20px', paddingTop:'10px'}}></img>
